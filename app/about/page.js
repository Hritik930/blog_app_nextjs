          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-center ">
              ...
              <p className="text-gray-600 dark:text-gray-50 text-lg mb-4">
                Hello! I am Hritik, a passionate software developer and tech
              ...
              <p className="text-gray-600 dark:text-gray-50 text-lg">
                ...
                skills, you will find a variety of resources and insights here.
                Let us explore the world of programming together!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">
              Hritik Journey as a Coder
            </h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-50">
              From curious beginner to seasoned developer, here is how Harry
